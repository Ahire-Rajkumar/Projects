...
Sample input:1. ./print_lines.sh 5 3 myfile.txt
             2. ./print_lines.sh myfile.txt
             3. ./print_lines.sh 5 10 myfile.txt
Sample Output:1. ./print_lines.sh 5 3 myfile.txt
              line number 5
              line number 6
              line number 7
...
then
    ...
    echo "Error: data.txt is having only 10 lines. file should have atleast 14 lines" 
                                     # cla arguments passing total valuve 10 above print the error
...
For eg. ./file_filter.sh 5 5 <file> "                            
                                     # cla aruments not passing print the error

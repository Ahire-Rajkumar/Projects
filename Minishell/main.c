...
root@Tulshi:~/Linux_Internals_Assign/P1_Minishell# gcc -o mini_shell main.c check_command.c echo.c get_command.c internal.c extract_external.c scan_input.c
root@Tulshi:~/Linux_Internals_Assign/P1_Minishell# ./mini_shell
